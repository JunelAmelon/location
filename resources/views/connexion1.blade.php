...
<header id="header" class="fixed-top ">
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-9 d-flex align-items-center justify-content-lg-between">
          ...
          <a href="/inscription" class="get-started-btn scrollto">sign up</a>
        </div>
      </div>
  ...
  <!-- Connection card -->
    ...
    <form method="POST" action="{{route('connexion')}}" class="container mt-5" style="width:50%; margin-bottom:4%; padding:0%; ">
      @if(session()->has('error'))
                        <p style="text-align: center; font-size:10px; color: #ea1f33;"> {{session()->get('error') }} </p>
      @endif
    <div class="row">
          <div class="mb-5 text-center" style="color:#00b371; font-weight: bold; font-size:38px" >Connectez - vous !</div>
         ...
         <div class="form-group">
            <input class="btn mt-1 w-25 " style="background-color:#00b371; color:white;" type="submit" name ="connexion" value="Se connecter">
        </div>   
        Vous n'avez pas un compte ? <a href="{{route('inscription')}}" style="color:#00b371; font-style: none;">Inscrivez-vous !</a>
      @csrf
    </form>
